...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.arrow.flight.protocol.HandshakeRequest.displayName =
    'proto.arrow.flight.protocol.HandshakeRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.arrow.flight.protocol.HandshakeResponse.displayName =
    'proto.arrow.flight.protocol.HandshakeResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.arrow.flight.protocol.FlightDescriptor = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.arrow.flight.protocol.FlightDescriptor.repeatedFields_,
    null,
  );
};
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.arrow.flight.protocol.FlightDescriptor.displayName =
...
proto.arrow.flight.protocol.FlightInfo = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.arrow.flight.protocol.FlightInfo.repeatedFields_,
    null,
  );
};
...
proto.arrow.flight.protocol.FlightEndpoint = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.arrow.flight.protocol.FlightEndpoint.repeatedFields_,
    null,
  );
};
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.arrow.flight.protocol.FlightEndpoint.displayName =
    'proto.arrow.flight.protocol.FlightEndpoint';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.arrow.flight.protocol.HandshakeResponse.prototype.toObject = function (
    opt_includeInstance,
  ) {
...
proto.arrow.flight.protocol.Criteria.prototype.getExpression_asB64 = function () {
  return /** @type {string} */ (jspb.Message.bytesAsB64(this.getExpression()));
};
...
proto.arrow.flight.protocol.Criteria.prototype.getExpression_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getExpression()));
};
...
proto.arrow.flight.protocol.SchemaResult.prototype.getSchema_asB64 = function () {
  return /** @type {string} */ (jspb.Message.bytesAsB64(this.getSchema()));
};
...
proto.arrow.flight.protocol.SchemaResult.prototype.getSchema_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getSchema()));
};
...
proto.arrow.flight.protocol.FlightDescriptor.deserializeBinaryFromReader = function (msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        var value = /** @type {!proto.arrow.flight.protocol.FlightDescriptor.DescriptorType} */ (
          reader.readEnum()
        );
        msg.setType(value);
        break;
...
proto.arrow.flight.protocol.FlightDescriptor.prototype.getType = function () {
  return /** @type {!proto.arrow.flight.protocol.FlightDescriptor.DescriptorType} */ (
...
proto.arrow.flight.protocol.FlightDescriptor.prototype.getCmd_asB64 = function () {
  return /** @type {string} */ (jspb.Message.bytesAsB64(this.getCmd()));
};
...
proto.arrow.flight.protocol.FlightDescriptor.prototype.getCmd_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getCmd()));
};
  ...
  proto.arrow.flight.protocol.FlightInfo.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        schema: msg.getSchema_asB64(),
        flightDescriptor:
          (f = msg.getFlightDescriptor()) &&
          proto.arrow.flight.protocol.FlightDescriptor.toObject(includeInstance, f),
        endpointList: jspb.Message.toObjectList(
          msg.getEndpointList(),
          proto.arrow.flight.protocol.FlightEndpoint.toObject,
          includeInstance,
        ),
  ...
  while (reader.nextField()) {
    ...
    switch (field) {
      ...
      case 2:
        ...
        reader.readMessage(
          value,
          proto.arrow.flight.protocol.FlightDescriptor.deserializeBinaryFromReader,
        );
      ...
      case 3:
        ...
        reader.readMessage(
          value,
          proto.arrow.flight.protocol.FlightEndpoint.deserializeBinaryFromReader,
        );
...
proto.arrow.flight.protocol.FlightInfo.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(2, f, proto.arrow.flight.protocol.FlightDescriptor.serializeBinaryToWriter);
  }
...
if (jspb.Message.GENERATE_TO_OBJECT) {
  ...
  proto.arrow.flight.protocol.FlightEndpoint.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        ticket:
          (f = msg.getTicket()) && proto.arrow.flight.protocol.Ticket.toObject(includeInstance, f),
        locationList: jspb.Message.toObjectList(
          msg.getLocationList(),
          proto.arrow.flight.protocol.Location.toObject,
          includeInstance,
        ),
      };
...
proto.arrow.flight.protocol.FlightEndpoint.serializeBinaryToWriter = function (message, writer) {
  ...
  f = message.getTicket();
  if (f != null) {
    writer.writeMessage(1, f, proto.arrow.flight.protocol.Ticket.serializeBinaryToWriter);
  }
  f = message.getLocationList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(2, f, proto.arrow.flight.protocol.Location.serializeBinaryToWriter);
  }
};
...
proto.arrow.flight.protocol.FlightEndpoint.prototype.addLocation = function (opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(
    ...
    2,
    opt_value,
    proto.arrow.flight.protocol.Location,
    opt_index,
  );
};
...
proto.arrow.flight.protocol.Ticket.prototype.getTicket_asB64 = function () {
  return /** @type {string} */ (jspb.Message.bytesAsB64(this.getTicket()));
};
...
proto.arrow.flight.protocol.Ticket.prototype.getTicket_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getTicket()));
};
...
proto.arrow.flight.protocol.FlightData.serializeBinaryToWriter = function (message, writer) {
  ...
  f = message.getFlightDescriptor();
  if (f != null) {
    writer.writeMessage(1, f, proto.arrow.flight.protocol.FlightDescriptor.serializeBinaryToWriter);
  }
...
proto.arrow.flight.protocol.FlightData.prototype.getDataHeader_asB64 = function () {
  return /** @type {string} */ (jspb.Message.bytesAsB64(this.getDataHeader()));
};
...
proto.arrow.flight.protocol.FlightData.prototype.getDataHeader_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getDataHeader()));
};
...
proto.arrow.flight.protocol.FlightData.prototype.getAppMetadata_asB64 = function () {
  return /** @type {string} */ (jspb.Message.bytesAsB64(this.getAppMetadata()));
};
...
proto.arrow.flight.protocol.FlightData.prototype.getAppMetadata_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getAppMetadata()));
};
...
proto.arrow.flight.protocol.FlightData.prototype.getDataBody_asB64 = function () {
  return /** @type {string} */ (jspb.Message.bytesAsB64(this.getDataBody()));
};
...
proto.arrow.flight.protocol.FlightData.prototype.getDataBody_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getDataBody()));
};
...
goog.object.extend(goog.object, proto.arrow.flight.protocol);
